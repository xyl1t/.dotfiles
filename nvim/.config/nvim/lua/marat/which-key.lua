...
local mappings = {
	...
	["f"] = { "<cmd>lua require'telescope.builtin'.find_files(require('marat.telescope').get_custom_dropdown())<cr>", "Find files", },
	...
	-- 	e  = { "<cmd>call vimspector#Reset()<CR>", "Stop" },
	-- 	n  = { "<cmd>call vimspector#Continue()<CR>", "Continue" },
	...
	-- 	B = { "<Plug>VimspectorToggleConditionalBreakpoint<CR>", "Toggle cond Breakpoint" },
	-- 	X  = { "<Plug>VimspectorClearBreakpoints<CR>", "Clear breakpoints" },
	-- 	i  = { "<Plug>VimspectorBalloonEval<CR>", "Inspect symbol" },
	-- },
